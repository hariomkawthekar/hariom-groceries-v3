...
export const CATEGORY_DETAILS = [
  ...
  { id: 'Fruits', name: 'Fruits', icon: '🍎', color: 'from-rose-500 to-pink-600', bgLight: 'bg-rose-50 text-rose-700 border-rose-200' },
  { id: 'Vegetables', name: 'Vegetables', icon: '🥕', color: 'from-emerald-600 to-green-700', bgLight: 'bg-emerald-50 text-emerald-800 border-emerald-200' },
